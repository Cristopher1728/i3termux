...
pkg update
pkg install xfce4 i3 tigervnc feh abiword gnumeric tilix firefox fastfetch vim htop w3m sc-im mc rofi lxappearance papirus-icon-theme cmatrix htop xarchiver unzip wget rsync pcmanfm curl -y
