...
pkg update
pkg install xfce4 i3 tigervnc xorg-xrandr ruby wget fastfetch vim htop w3m sc-im mc rofi nitrogen lxappearance pipewire papirus-icon-theme cmatrix htop xarchiver pcmanfm curl -y
